...
#if defined(__clang__) && __has_feature(cxx_alias_templates)
...
#define _TLS_QUAL	/* TLS qualifier, such as __declspec(thread), if any */
...
#elif _HAS_TR1 && (1400 <= _MSC_VER || __EDG__ || __GNUC__ || (defined(__CODEGEARC__) && defined(__clang__)))
...
#if !defined(__MT__) || defined(_NO_MT) || defined(_DEBUG) && 1310 == _MSC_VER
 ...
 #elif 409 <= __EDG_VERSION__ || _CLANG
...
#elif _HAS_CPP0X && (defined(__CODEGEARC__) && defined(__clang__))
  #define _HAS_CONSTEXPR	1	/* enable constexpr */
...
#elif _HAS_CPP0X && (1600 <= _MSC_VER || _GCC0X || 403 <= __EDG_VERSION__ || defined(__CODEGEARC__))
...
#if _MULTI_THREAD || (defined(__CODEGEARC__) && defined(_WIN64))
...
_CRTIMP2 long _InterlockedIncrement(long volatile *);
_CRTIMP2 long _InterlockedDecrement(long volatile *);
...
_END_EXTERN_C
 ...
 #define _MAX_LOCK		8	/* one more than highest lock number */
  ...
  #define _MAYBE_LOCK	\
    if (_Locktype == _LOCK_MALLOC || _Locktype == _LOCK_DEBUG || _Locktype == _LOCK_CALL_ONCEEX)
